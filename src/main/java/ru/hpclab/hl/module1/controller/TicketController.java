...
public class TicketController {
    ...
    public List<Map<String, Object>> getTicketStats() {
        this.observabilityService.start(getClass().getSimpleName() + ":getTicketStats");
        List<Map<String, Object>> temp = ticketService.getViewersCountBySector();
        this.observabilityService.stop(getClass().getSimpleName() + ":getTicketStats");
        return temp;
    }
}